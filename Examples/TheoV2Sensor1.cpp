...
* Version        : R108 - DS18B20 and BH1750 and Vcc test
* Date           : 20140403
* 
* This code turns an Atmel ATTiny85 chip into a Sensor using the TheoV1 protocol.
* This code is not of any use without running a Unit within RF range to receive sensor data.
\***************************************************************************************************************/

// 1 = DS18B20 and BH1750 sensor
#define SENSOR_TYPE 1                            // 0 - 31
...
#define VREF_35             10640                // Measured value for Vref at 3.5V Vcc * 10 (Chip dependent)
...
void loop()
{
  ...
  Watchdog_sleep(SEND_DELAY);                    // Go to deep sleep mode for some time
}
